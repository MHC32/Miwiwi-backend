...
const { meterUpload } = require('../utils/uploadUtils');
...
router.post('/readings', requireAuth, isCashier, meterUpload.checkUploadDir, meterUpload.upload.single('photo'), cashierController.createMeterReading);
