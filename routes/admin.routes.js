...
// Products
router.post('/products', requireAuth, isAdmin, productUpload.checkUploadDir, productUpload.upload.array('images', 5), adminController.createProduct); // ✅ Modifié
...
router.patch('/products/:id', requireAuth, isAdmin, productUpload.checkUploadDir, productUpload.upload.array('images', 5), adminController.updateProduct); // ✅ Modifié
